...
(function (self) {
    ...
    var storageName = 'ins-form-control-storage-opt57312';
    var formInformation = [
        {
    ...
    var formAbandonedStorage = Insider.storage.session.get(storageName);/* OPT-62085 */
        ...
        if (Insider.systemRules.call('isOnCartPage') || Insider.fns.hasParameter('/contact-form') ||
            ...
            Insider.eventManager.once('mouseout.mouse:left:window:' + variationId, window, function (mouseEvent) {
                if (!mouseEvent.toElement && !mouseEvent.relatedTarget && mouseEvent.clientY < 0) {
                    formAbandonedStorage = Insider.storage.session.get(storageName); /* OPT-62085 */
